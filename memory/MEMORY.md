...
## 🔴 조직 & 업무현황 (2026-06-16 13:24 KST) — 회귀 감지 (2/4 DOWN, TRAVEL 신규 DOWN)

- [🔴 org_status (13:24 KST)](org_status_20260616_1324.md) — **🔴 P1 2/4 DOWN (회귀 발생)** | **신뢰도 50%** | **HTTP 200: /, /api/assets | HTTP 404: /audit (14h), /assets (신규 <5m)** | **AUDIT-P1 + TRAVEL-P2-UI 배포 실패** | **블로커 2건** | **팀 0% (배포 블로커)** | **마감 80h 41m** | **다음 13:29 KST**
