...
```
memory/
├── TRUST_SCORE_CALCULATOR_DESIGN.md          [THIS FILE, 1200+ lines]
│   └── Architecture + formulas + roadmap
│
├── TRUST_SCORE_TEST_SPECIFICATION.md         [100 test cases, 400+ lines]
...
2. 100 test cases (TRUST_SCORE_TEST_SPECIFICATION.md)
