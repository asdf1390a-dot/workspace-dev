  ...
  return (
    <JeepneyLayout>
      <header style={{ padding: '20px 4px 8px' }}>
        ...
        <h1 style={{ margin: '8px 0 4px', fontSize: 'clamp(22px, 4vw, 28px)', fontWeight: 700 }}>언어</h1>
        <p style={{ margin: 0, color: 'var(--jp-text-muted)', fontSize: 14 }}>한국어 / English / தமிழ் 중 선택합니다.</p>
      </header>
