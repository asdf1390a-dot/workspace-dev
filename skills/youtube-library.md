...
| 날짜 | 제목 | 채널 | 길이 | 태그 |
|------|------|------|------|------|
| 2026-05-12 | [Rick Astley - Never Gonna Give You Up (Official Video) (4K Remaster)](https://youtu.be/dQw4w9WgXcQ) | Rick Astley | 3분 | `일반` |
| 2026-05-12 | [Next.js in 100 Seconds // Plus Full Beginner's Tutorial](https://www.youtube.com/watch?v=Sklc_fQBmcs) | Fireship | 11분 | `웹개발` |
| 2026-05-12 | [옵시디언에 클로드 코드 연결하면 이런 일이 가능합니다 | 정보 정리부터 사업 시스템까지 obsidian & claude code](https://youtu.be/OVilj8E2NnM?si=dP1qQnL9UPu2L-FH) | 태오의 실행 비즈니스 | AI 에이전트 | 26분 | `설계` |
| 2026-05-12 | [클로드 코드, 코덱스 스킬 관리 전략 왕초보 가이드](https://youtu.be/zeNQqd5Q5Lo?si=_cPoqfJmdUEf8qDe) | 편집자P | 28분 | `웹개발` `설계` |
| 2026-05-12 | [왕초보용 0부터 시작하는 하네스 엔지니어링 with 코덱스(코덱스 세팅까지)](https://youtu.be/uB2m8MATXow?si=64o6k9XeaB2n8UEo) | 편집자P | 38분 | `웹개발` |
| 2026-05-12 | [바이브코딩계 GD가 공유한 CLAUDE.md 나눕니다](https://youtu.be/xnNFexW9Wrk?si=CM2TedTFM_adDUuS) | 미드나잇 로그 Midnight Log | 12분 | `웹개발` `설계` |
| 2026-05-13 | [클로드코드 대박 신기능 Agent View | 멀티 에이전트 관리가 너무 쉽습니다](https://youtu.be/MPWKZzP-bQs?si=mE9fcaksX5q_vB3e) | 개발동생 | 10분 | `웹개발` |
| 2026-05-13 | [코딩 몰라도 가능! 클로드(Claude)로 구축한 1인 기업 6배속 자동화 시스템 (비용 절감 & 수익화 전략)](https://youtu.be/AYBqJ5eKspY?si=w_boQBokIXI9UG3n) | 미국주부, Mompreneur Diary | 26분 | `웹개발` |
| 2026-05-15 | [이거 그대로만 따라하세요. 코덱스, 클로드코드가 10배는 똑똑해집니다](https://youtu.be/2dZmqok1uFY?si=_3Epzvq33fHtO-j9) | 신영선의 AI탐구 | 20분 | `웹개발` `설계` |
| 2026-05-15 | [GitHub Stars 5만개 받은 Claude Code 오픈소스 도구, 진짜로 써볼 만한 건 몇 개일까?](https://youtu.be/oVqtmiCcQ8g?si=KHCyASiBRCNhOwpH) | PolarBear's Story | 8분 | `일반` |
| 2026-05-15 | [서브에이전트 모르면 클로드 코드 돈 버리는 겁니다 | EP.06](https://youtu.be/Qr3pyVpd8CY?si=TKImwAQ20s8LcOmL) | Theuxlabs | 19분 | `웹개발` |
| 2026-05-15 | [클로드코드 10개월… 매일 12시간 쓰며 알게 된 50가지](https://youtu.be/MYEYID9Euzs?si=86-uAi65m9X35kw2) | 메이커 에반 | Maker Evan | 16분 | `웹개발` |
